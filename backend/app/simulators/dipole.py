...
"""
Dipole antenna simulator with optimized FDTD parameters.
...
def simulate_dipole(
    ...
    nrts = get_optimized_nrts(f0, "dipole", with_radiation)
    ...
    try:
        ...
        if with_radiation and nf2ff is not None:
            # Optimized: Reduced NF2FF sampling points (19x37 = 703 vs 37x73 = 2701)
            ...
            result["results"]["radiation"] = {
                ...
                "nf2ff_points": len(theta) * len(phi),  # Metadata for benchmarking
            }
